                            ...
                            <section class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group row pb-3">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="categories_name" class="form-control" placeholder="eg.: Anna Sui" required/>
                                        </div>
                                    </div>
                                    <div class="form-group row pb-2">
                                        <label class="col-sm-3 control-label text-sm-end pt-2">Category Description <span class="required">*</span></label>
                                        <div class="col-sm-6">
                                            <textarea name="categories_description" rows="5" class="form-control" placeholder="Describe Product" required></textarea>
                                        </div>
                                    </div>
                                </div>
